...
public struct MarkerStyle: Sendable, Equatable {
    ...
    /// Whether source delimiters reveal around the active caret or selection.
    /// Disable this for a fully visual editor that keeps Markdown only as its
    /// persisted representation.
    public var revealsActiveMarkers: Bool
